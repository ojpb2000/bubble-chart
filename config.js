...
const config = {
    ...
    dataPathsV1: {
        manufacturer: 'Pathmathics_Brand_Manufacturer_Classified.csv',
        dme: 'Pathmatics_DME_classified.csv',
        instagram: 'SM_IG_rows_all.csv',
        tiktok: 'SM_TikTok_rows_1_20000.csv'
    },
    
    // Data paths for v2 (new structure)
    dataPathsV2: {
        manufacturer: 'Pathmathics_Brand_Manufacturer_Classified_v2.csv',
        dme: 'Pathmatics_DME_classified_v2.csv',
        instagram: 'SM_IG_Breast_Pump_Brands_analyzed_v2.csv',
        tiktok: 'SM_TikTok_Breast_Pump_Brands_analyzed_v2.csv'
    },
